        ...
        {(appState === AppState.IDLE || appState === AppState.ERROR) && (
          <div className="max-w-4xl mx-auto pt-8 md:pt-16 animate-fadeIn">
            ...
            <div className="mt-16 grid grid-cols-3 gap-4 text-center opacity-50">
               <div>
                  <div className="font-bold text-slate-300 mb-1">It Sees</div>
                  <div className="text-sm">Identifies failure points & materials</div>
               </div>
               <div>
                  <div className="font-bold text-slate-300 mb-1">It Reasons</div>
                  <div className="text-sm">Simulates physics & structural integrity</div>
               </div>
               <div>
                  <div className="font-bold text-slate-300 mb-1">It Visualizes</div>
                  <div className="text-sm">Generates step-by-step 3D guides</div>
               </div>
            </div>
          </div>
        )}
